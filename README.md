...
**1)** Clone this repository on your laptop. If you are using `GYEMS-RMD L7015-10T` motors, you can directly build the Arduino project in `3_Motor_CAN_UDP_RTOS` folder and then upload to Teensy; otherwise, configure correct [torque constant](https://github.com/Jarvis861/Caracal_Teensy/blob/3c5ba12216b3b84911c2a8483f05245a964b8384/3_Motor_CAN_UDP_RTOS/lib/RMD_Motor/RMD_Motor.hpp#L9-L13) and [reduction ratio](https://github.com/Jarvis861/Caracal_Teensy/blob/3c5ba12216b3b84911c2a8483f05245a964b8384/3_Motor_CAN_UDP_RTOS/lib/RMD_Motor/RMD_Motor.cpp#L34) first.
